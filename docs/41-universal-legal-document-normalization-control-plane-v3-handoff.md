...
`40-document-normalization-pipeline-v2-handoff.md`, while preserving V2's accepted provenance,
...
- `40-document-normalization-pipeline-v2-handoff.md` — historical design provenance and detailed
...
Retain the persistence model introduced by migration 0048:
...
4. preserve migration 0048 semantics or deliberately supersede them with equal/stronger provenance.
