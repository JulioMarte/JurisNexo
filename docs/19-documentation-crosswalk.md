...
- `40-document-normalization-pipeline-v2-handoff.md` — current operational implementation handoff for manifest-driven Docling/OCR normalization, quality judging, visual verification, canaries and reconciliation;
