...
- `43-jev-system-one-engineering-guidelines.md` — current JEV/System One design, batching, calibration, shadow/promotion and evidence-routing contract for JurisNexo.
