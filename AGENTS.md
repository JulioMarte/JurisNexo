...
10. `docs/testing/repository-governance-contract.md` — HARD / CONTROLLED / FLEXIBLE / HISTORICAL repository rules;
11. `docs/testing/evidence-authoring-guide.md` and the nearest `AGENTS.md` when changing tests;
12. `docs/02-legal-corpus-and-data-model.md` when changing persisted legal/corpus data;
13. `docs/03-research-agent-and-report-contract.md` when changing legal research behavior;
14. `docs/10-job-state-machines-and-reproducibility.md` when changing long-running jobs or durable execution;
15. `docs/11-benchmark-annotation-and-evaluation-protocol.md` and `docs/17-agent-methodology-and-benchmark-map.md` when changing benchmarks, retrieval, agent behavior, or research methods;
16. `docs/05-security-privacy-and-trust.md` and `docs/09-tenancy-authentication-and-access-control.md` for trust/tenant-sensitive changes;
17. `docs/18-migration-plan-custom-harness-to-agents-sdk.md` for runtime migration work;
18. `docs/27-database-bootstrap-and-multi-court-registry.md` for database bootstrap, PostgreSQL configuration, and ephemeral-CI database policy.
